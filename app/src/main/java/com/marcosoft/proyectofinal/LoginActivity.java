...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "marco@exa.com:hola", "bar@example.com:world"
    };
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mRegistrarButton = (Button) findViewById(R.id.btnRegistrar);
        mRegistrarButton.setOnClickListener(new View.OnClickListener(){

            @Override
            public void onClick (View v){
                Intent ListSong = new Intent(getApplicationContext(), RegistroActivity.class);
